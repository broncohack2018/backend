defmodule BackendWeb.ProductControllerTest do
  ...
  @create_attrs %{description: "some description", feature: "some feature", name: "some name", price: 120.5, story: "some story"}
  ...
  def fixture(:product) do
    {:ok, product} = Platform.create_product(@create_attrs)
    product
  end
